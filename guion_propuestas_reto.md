#  Reto socioecológico: Creación de propuestas para alcanzar los escenarios futuros
...
+ Al nombre de la propuesta hay que añadir las siguientes características:
  ...
  + Conexión de la propuesta con lo que sabemos de ámbitos de gestión sectorial. Es decir, la propuesta en cuestión debe de conectarse de alguna manera con la forma en la que actualmente gestionamos la pesca, la caza, los bosques, etc. Esto se relaciona, lógicamente, con [esta](https://aprendiendo-cosas.github.io/A_clase_invertida_gesteco_ccaa/guion_preparar_clase_invertida.html) actividad en la que estáis trabajando. O dicho de otra forma, las propuestas concretas que planteamos para aplicar los escenarios que hemos identificado se alimentan de técnicas de gestión que se usan en la actualidad. La diferencia fundamental entre la aproximación actual y la mirada sistémica que intentamos abordar aquí, es que en nuestro caso combinamos medidas sectoriales de varios tipos para generar un "tratamiento" sistémico al problema identificado.
